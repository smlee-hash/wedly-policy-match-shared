...
// ★「사회적기업」·「예비창업자」는 규모가 아니라 **자격**이라 여기 두지 않는다(독립 리뷰 2026-09-17 H-B).
// 프로필 규모 칸은 중소기업·소상공인·중견기업·예비창업자 넷뿐이라 「사회적기업」 값을 담을 수 없고,
// 그 상태로 대조하면 **인증 사회적기업이 자기 공고에서 fail 로 지워진다**. 자격은 targetOrg 가 맡는다.
